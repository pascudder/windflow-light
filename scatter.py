...
def main():
    ...
    wv_mask = (wv_mask * 0.05 * 111 * 1000) / 10800 #test to reduce bias
    ...
    ax.set_xlabel('ECO1280 u-component m/s')
    ax.set_ylabel('Windflow u-component m/s')
    plt.savefig("scatter_density.ucomp_500_90to90_pixel.png")
    ...
    plt.savefig("scatter.vcomp_500_90to90_pixel.png")
    ...
    ax.set_xlabel('ECO1280 v-component m/s')
    ax.set_ylabel('Windflow v-component m/s')
    plt.savefig("scatter_density.vcomp_500_90to90_pixel.png")
